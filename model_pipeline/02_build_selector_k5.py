"""
XAUUSD K=5 Rolling-Window Regime Selector
==========================================
...
# ── Load data ──
DATA_PATH = P.data("swing_v5_xauusd.csv")
...
ax.set_title("XAUUSD K=5 Rolling-Window Clustering", color="#FFD700", fontsize=14)
