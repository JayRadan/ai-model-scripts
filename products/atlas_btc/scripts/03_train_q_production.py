"""
Atlas BTC — production bundle training.

Produces:
  /home/jay/Desktop/my-agents-and-website/commercial/server/decision_engine/models/atlas_btc_validated.pkl
...
DATA = ROOT / "data/m1_btc_orderflow.parquet"
...
def main():
    print("="*72); print("  Atlas BTC production bundle"); print("="*72)
    t0 = time.time()
    ...
    payload = {
        ...
        "train_meta": {
            ...
            "strategy": "Atlas STRICT candle confirm + both-lines + MFE>=2R + multi-pos + BE@+0.5R (BTC)",
            "config_snapshot": {
