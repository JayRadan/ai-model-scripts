"""
10_sim_today.py — Atlas BTC live-equivalent simulation for the current day.
...
Pipeline:
  1. load deployed bundle (atlas_btc_validated.pkl, M15 U-shape Q)
  2. fetch last ~3 days of M1 BTC from Dukascopy
...
def main():
    t0 = time.time()
    print(f"[atlas_btc] loading bundle ...")
