...
with open(P.data("regime_selector_btc_K5.json")) as f:
    sel = json.load(f)
...
lines = []
lines.append("//+------------------------------------------------------------------+")
lines.append("//| regime_selector_btc.mqh                                               |")
lines.append("//| Auto-generated from regime_selector_btc_K5.json. DO NOT EDIT BY HAND. |")
lines.append("//|                                                                   |")
lines.append("//| Usage:                                                            |")
...
out = str(P.LIVE_DIR / "MQL5_Include" / "regime_selector_btc.mqh")
import os
