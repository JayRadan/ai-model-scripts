"""
EURUSD M5 causal swing labeler.
Reads swing_eurusd_m5.csv, adds proper BUY/FLAT/SELL labels based on
forward TP/SL outcome, outputs labeled_eurusd.csv.
"""
import pandas as pd
import numpy as np
import paths as P
...
OUT_PATH = P.data("labeled_eurusd.csv")
MIN_DATE = "2016-01-01"
