...
def load_and_split():
    all_setups = []
    for f in sorted(glob.glob("/home/jay/Desktop/new-model-zigzag/experiments/v74_pivot_score/data/setups_*_v74.csv")):
...
def main():
    ...
    out_trades = "/home/jay/Desktop/new-model-zigzag/experiments/v74_pivot_score/reports/v74_trades_holdout.csv"
    ...
    with open("/home/jay/Desktop/new-model-zigzag/experiments/v74_pivot_score/reports/meta_threshold_v74.txt", "w") as f:
        f.write(f"{best_thr:.4f}\n")
    print(f"\n  Saved meta threshold to meta_threshold_v74.txt: {best_thr:.4f}")
