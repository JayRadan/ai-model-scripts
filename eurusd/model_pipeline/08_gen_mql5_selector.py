...
constants. EURUSD version — 4 clusters, all tradeable.
"""
import json
import os
import numpy as np
...
lines = []
lines.append("//+------------------------------------------------------------------+")
lines.append("//| regime_selector_eurusd.mqh                                       |")
lines.append("//| Auto-generated from regime_selector_K4.json. DO NOT EDIT BY HAND.|")
lines.append("//+------------------------------------------------------------------+")
lines.append("#ifndef __REGIME_SELECTOR_EURUSD_MQH__")
lines.append("#define __REGIME_SELECTOR_EURUSD_MQH__")
lines.append("")
...
lines.append("")
lines.append("// Cluster meta — 0:Uptrend 1:MeanRevert 2:TrendRange 3:Downtrend 4:HighVol")
...
out = str(P.LIVE_DIR / "MQL5_Include" / "regime_selector_eurusd.mqh")
