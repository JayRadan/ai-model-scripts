...
def build(name, parquet, instr, bm, maxh, target_per_day, cd, trading_days_frac, cols=None):
    ...
    bak = MODELS / f"{name}_validated.pkl.bak_pre_edge_m5_2026-07-08"
...
build("oracle_btc", "/home/jay/Desktop/new-model-zigzag/data/m1_btc_orderflow_8y.parquet",
      INSTRUMENT_VCCY_BTC_USD, bm=5, maxh=60, target_per_day=5.0, cd=3, trading_days_frac=1.0,
      cols=["time", "open", "high", "low", "close", "tick_volume"])
log("oracle_btc bundle built")
