"""
GBPJPY regime clustering — K-means on weekly scale-invariant fingerprints.
Same approach as gold/EURUSD: 7 features computed from % returns so clusters
...
DATA_PATH = P.data("labeled_gbpjpy.csv")
K = 4
MIN_CANDLES = 200
...
plt.suptitle(f"GBPJPY Regime Clusters (K={K})", fontsize=14)
plt.tight_layout()
