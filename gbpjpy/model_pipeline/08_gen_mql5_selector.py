...
constants. GBPJPY version — 4 clusters, all tradeable.
"""
import json
import os
import numpy as np
...
lines = []
lines.append("//+------------------------------------------------------------------+")
lines.append("//| regime_selector_gbpjpy.mqh                                       |")
lines.append("//| Auto-generated from regime_selector_K4.json. DO NOT EDIT BY HAND.|")
lines.append("//+------------------------------------------------------------------+")
lines.append("#ifndef __REGIME_SELECTOR_GBPJPY_MQH__")
lines.append("#define __REGIME_SELECTOR_GBPJPY_MQH__")
lines.append("")
...
out = str(P.LIVE_DIR / "MQL5_Include" / "regime_selector_gbpjpy.mqh")
